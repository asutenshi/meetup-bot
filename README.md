...
- [`CONCEPT.md`](./CONCEPT.md) — проблема, ключевые решения, скоуп MVP и backlog.
- [`TZ.md`](./TZ.md) — технический стек, модель данных, архитектура, roadmap.
...
Проект в разработке по этапам, описанным в [`TZ.md`, раздел 7](./TZ.md#7-этапы-реализации-roadmap).
